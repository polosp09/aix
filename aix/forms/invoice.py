...
from aix.models import (AccountModel, CustomerModel, InvoiceModel, ItemThroughModel, ItemModel)
...
class InvoiceModelCreateForEstimateForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            'customer': Select(attrs={'class': MANDO_FORM_INPUT_CLASSES}),
            ...
            'cash_account': Select(attrs={'class': MANDO_FORM_INPUT_CLASSES}),
            'prepaid_account': Select(attrs={'class': MANDO_FORM_INPUT_CLASSES}),
            'unearned_account': Select(attrs={'class': MANDO_FORM_INPUT_CLASSES}),
...
class BaseInvoiceModelUpdateForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            'date': DateInput(attrs={'class': MANDO_FORM_INPUT_CLASSES}),
            'terms': Select(attrs={'class': MANDO_FORM_INPUT_CLASSES}),
            'invoice_status': Select(attrs={'class': MANDO_FORM_INPUT_CLASSES}),
            'customer': Select(attrs={'class': MANDO_FORM_INPUT_CLASSES}),
            'paid_date': DateInput(
                attrs={
                    'class': MANDO_FORM_INPUT_CLASSES,
