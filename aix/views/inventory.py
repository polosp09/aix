...
from aix.models import EntityModel, inventory_adjustment
from aix.models.items import ItemThroughModel
from aix.views.mixins import LoginRequiredMixIn


class InventoryListView(LoginRequiredMixIn, ListView):
    template_name = 'aix/inventory_list.html'
...
class InventoryRecountView(LoginRequiredMixIn, DetailView):
    template_name = 'aix/inventory_recount.html'
    http_method_names = ['get']
    ...
    def get_context_data(self, adjustment=None, counted_qs=None, recorded_qs=None, **kwargs):
        ...
        if counted_qs is not None and recorded_qs is not None:
        ...
        context['is_any_received'] = self.counted_inventory()
        # if self.counted_inventory() is not None:
            # context['is_any_received'] = True
    ...
    def get(self, request, *args, **kwargs):
        ...
        if confirm:
            ...
            return HttpResponseRedirect(
                redirect_to=reverse('aix:inventory-recount',
                                    kwargs={
                                        'entity_slug': self.kwargs['entity_slug']
                                    })
            )
