...
from aix.forms.account import AccountModelUpdateForm, AccountModelCreateForm, AccountModelCreateChildForm
...
class AccountModelListView(LoginRequiredMixIn, ListView):
    template_name = 'aix/account_list.html'
...
class AccountModelUpdateView(LoginRequiredMixIn, UpdateView):
    ...
    template_name = 'aix/account_update.html'
...
class AccountModelCreateView(LoginRequiredMixIn, CreateView):
    template_name = 'aix/account_create.html'
...
class AccountModelCreateChildView(AccountModelCreateView):
    template_name = 'aix/account_create_child.html'
...
class AccountModelDetailView(LoginRequiredMixIn, RedirectView):
    ...
    def get_redirect_url(self, *args, **kwargs):
        loc_date = localdate()
        return reverse('aix:account-detail-month',
                       kwargs={
                           'entity_slug': self.kwargs['entity_slug'],
...
class AccountModelYearDetailView(LoginRequiredMixIn,
                                 ...
                                 DetailView):
    context_object_name = 'account'
    template_name = 'aix/account_detail.html'
    slug_url_kwarg = 'account_pk'
    slug_field = 'uuid'
    DEFAULT_TXS_DAYS = 30
    extra_context = {
