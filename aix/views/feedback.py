...
from aix.settings import MANDO_FEEDBACK_EMAIL_LIST, MANDO_FEEDBACK_FROM_EMAIL
from aix.views.mixins import LoginRequiredMixIn, SuccessUrlNextMixIn
...
class BugReportView(LoginRequiredMixIn,
    ...
    def form_valid(self, form):
        ...
        if MANDO_FEEDBACK_EMAIL_LIST:
            send_mail(
                subject=f'DJL Bug Report',
                from_email=MANDO_FEEDBACK_FROM_EMAIL,
                recipient_list=MANDO_FEEDBACK_EMAIL_LIST,
                fail_silently=True,
                message=message)
