...
from aix.forms.data_import import OFXFileImportForm
#from aix.forms.data_import import StagedTransactionFormSet
#from aix.io.ofx import OFXFileManager
from aix.models.accounts import AccountModel
from aix.models.bank_account import BankAccountModel
from aix.models.data_import import ImportJobModel, StagedTransactionModel
...
class DataImportJobsListView(LoginRequiredMixIn, ListView):
    ...
    template_name = 'aix/data_import_job_list.html'
...
class DataImportOFXFileView(LoginRequiredMixIn, FormView):
    template_name = 'aix/data_import_ofx.html'
...
class DataImportJobDetailView(LoginRequiredMixIn, DetailView):
    template_name = 'aix/data_import_job_txs.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        if not cash_account_model:
            bank_acct_url = reverse('aix:bank-account-update',
                                    kwargs={
                                        'entity_slug': self.kwargs['entity_slug'],
        ...
        txs_formset = StagedTransactionFormSet(
            user_model=self.request.user,
            entity_slug=self.kwargs['entity_slug'],
    ...
    def post(self, request, **kwargs):
        ...
        txs_formset = StagedTransactionFormSet(request.POST,
                                                    user_model=self.request.user,
        ...
        if txs_formset.is_valid():
            ...
            if len(staged_to_import) > 0:
                ...
                StagedTransactionModel.objects.bulk(staged_tx_models, fields=['tx'])
