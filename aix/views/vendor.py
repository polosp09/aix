...
from aix.forms.vendor import VendorModelForm
...
class VendorModelListView(LoginRequiredMixIn, ListView):
    template_name = 'aix/vendor_list.html'
    context_object_name = 'vendors'
    PAGE_TITLE = _('Supplier List')
    extra_context = {
...
class VendorModelCreateView(LoginRequiredMixIn, CreateView):
    template_name = 'aix/vendor_create.html'
    PAGE_TITLE = _('Create New Supplier')
...
class VendorModelUpdateView(LoginRequiredMixIn, UpdateView):
    template_name = 'aix/vendor_update.html'
    PAGE_TITLE = _('Supplier Update')
    context_object_name = 'vendor'
    form_class = VendorModelForm
    extra_context = {
        'page_title': PAGE_TITLE,
