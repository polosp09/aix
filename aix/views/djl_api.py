...
# from aix.models.schemas import SCHEMA_PNL, SCHEMA_NET_PAYABLES, SCHEMA_NET_RECEIVABLE
# from aix.settings import MANDO_VALIDATE_SCHEMAS_AT_RUNTIME
from aix.utils import accruable_net_summary
from aix.views.mixins import LoginRequiredMixIn, EntityUnitMixIn
...
class PnLAPIView(LoginRequiredMixIn, EntityUnitMixIn, View):
    ...
    def get(self, request, *args, **kwargs):
        if request.user.is_authenticated:
            ...
            # if MANDO_VALIDATE_SCHEMAS_AT_RUNTIME:
            #     try:
