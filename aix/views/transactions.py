...
from aix.forms.transactions import TransactionFormSet
...
class TXSJournalEntryView(LoginRequiredMixIn, TemplateView):
    ...
    def get_context_data(self, txs_formset=None, **kwargs):
        ...
        if not txs_formset:
            context['txs_formset'] = TransactionFormSet(
    ...
    def post(self, request, **kwargs):
        ...
        txs_formset = TransactionFormSet(request.POST,
                                              user_model=self.request.user,
