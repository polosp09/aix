...
from aix.forms.journal_entry import JournalEntryModelUpdateForm, JournalEntryModelCreateForm
...
class JournalEntryListView(LoginRequiredMixIn, ListView):
    ...
    template_name = 'aix/je_list.html'
...
class JournalEntryDetailView(LoginRequiredMixIn, DetailView):
    ...
    template_name = 'aix/je_detail.html'
...
class JournalEntryUpdateView(LoginRequiredMixIn, UpdateView):
    context_object_name = 'journal_entry'
    template_name = 'aix/je_update.html'
    slug_url_kwarg = 'je_pk'
    ...
    def get_success_url(self):
        return reverse('aix:je-list', kwargs={
            'entity_slug': self.kwargs['entity_slug'],
            'ledger_pk': self.kwargs['ledger_pk']
        })
...
class JournalEntryCreateView(LoginRequiredMixIn, CreateView):
    template_name = 'aix/je_create.html'
