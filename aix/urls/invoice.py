...
urlpatterns = [
    ...
    path('<slug:entity_slug>/create/jobcard/<uuid:jcd_pk>/',
         views.InvoiceModelCreateView.as_view(for_work_order_jobcard=True),
         name='invoice-create-jcd'),
    ...
    path('<slug:entity_slug>/report/<uuid:invoice_pk>/',
         views.InvoiceReportView.as_view(dwn_report_file=True),
         name='invoice-rpt'),
    path('<slug:entity_slug>/report/receipt/<uuid:invoice_pk>/',
         views.InvoiceReportView.as_view(for_receipt=True,dwn_report_file=True),
         name='customer-receipt-rpt'),
]
