...
urlpatterns = [
    ...
    path('<slug:entity_slug>/report/<uuid:bill_pk>/',
         views.BillReportView.as_view(dwn_report_file=True),
         name='bill-rpt'),
    path('<slug:entity_slug>/report/receipt/<uuid:bill_pk>/',
         views.BillReportView.as_view(for_receipt=True,dwn_report_file=True),
         name='vendor-receipt-rpt'),
]
