...
from aix.models import CreateUpdateMixIn, EntityModel, MarkdownNotesMixIn, ItemModel, CustomerModel
...
class EstimateModelAbstract(CreateUpdateMixIn, MarkdownNotesMixIn):
    ...
    customer = models.ForeignKey('aix.CustomerModel', on_delete=models.RESTRICT, verbose_name=_('Customer'))
    ...
    def get_mark_as_draft_url(self):
        return reverse('aix:customer-estimate-action-mark-as-draft',
                       kwargs={
    ...
    def get_mark_as_review_url(self):
        return reverse('aix:customer-estimate-action-mark-as-review',
                       kwargs={
                           'entity_slug': self.entity.slug,
                           'ce_pk': self.uuid
                       })
    ...
    def get_mark_as_approved_url(self):
        return reverse('aix:customer-estimate-action-mark-as-approved',
                       kwargs={
                           'entity_slug': self.entity.slug,
                           'ce_pk': self.uuid
                       })
    ...
    def get_mark_as_completed_url(self):
        return reverse('aix:customer-estimate-action-mark-as-completed',
                       kwargs={
                           'entity_slug': self.entity.slug,
                           'ce_pk': self.uuid
                       })
    ...
    def get_mark_as_canceled_url(self):
        return reverse('aix:customer-estimate-action-mark-as-canceled',
                       kwargs={
                           'entity_slug': self.entity.slug,
                           'ce_pk': self.uuid
                       })
    ...
    def get_mark_as_void_url(self):
        return reverse('aix:customer-estimate-action-mark-as-void',
                       kwargs={
                           'entity_slug': self.entity.slug,
                           'ce_pk': self.uuid
                       })
