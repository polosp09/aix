...
from aix.models.mixins import CreateUpdateMixIn
...
class ImportJobModelAbstract(CreateUpdateMixIn):
    ...
    ledger = models.ForeignKey('aix.LedgerModel',
                               editable=False,
...
class StagedTransactionModelAbstract(CreateUpdateMixIn):
    uuid = models.UUIDField(default=uuid4, editable=False, primary_key=True)
    import_job = models.ForeignKey('aix.ImportJobModel',
                                   on_delete=models.CASCADE)
    earnings_account = models.ForeignKey('aix.AccountModel',
                                         on_delete=models.CASCADE,
                                         null=True,
                                         blank=True)
    ...
    tx = models.OneToOneField('aix.TransactionModel',
