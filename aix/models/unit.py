...
from aix.io.io_mixin import IOMixIn
from aix.models.mixins import CreateUpdateMixIn, SlugNameMixIn, ParentChildMixIn
...
class EntityUnitModelAbstract(IOMixIn, ParentChildMixIn, SlugNameMixIn, CreateUpdateMixIn):
    ...
    def get_dashboard_url(self):
        return reverse('aix:unit-dashboard',
                       kwargs={
