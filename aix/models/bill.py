...
class BillModelManager(models.Manager):
    ...
    def for_entity_bills(self, entity_slug, user_model):
...
class BillModelAbstract(LedgerWrapperMixIn,
    ...
    vendor = models.ForeignKey('aix.VendorModel',
                               on_delete=models.CASCADE,
                               verbose_name=_('Vendor'))
    additional_info = models.JSONField(blank=True,
                                       null=True,
                                       verbose_name=_('Bill Additional Info'))
    bill_items = models.ManyToManyField('aix.ItemModel',
    ...
    def get_mark_as_draft_url(self):
        return reverse('aix:bill-action-mark-as-draft',
                       kwargs={
    ...
    def get_mark_as_review_url(self):
        return reverse('aix:bill-action-mark-as-review',
                       kwargs={
                           'entity_slug': self.ledger.entity.slug,
                           'bill_pk': self.uuid
                       })
    ...
    def get_mark_as_approved_url(self):
        return reverse('aix:bill-action-mark-as-approved',
                       kwargs={
                           'entity_slug': self.ledger.entity.slug,
                           'bill_pk': self.uuid
                       })
    ...
    def get_mark_as_delete_url(self):
        return reverse('aix:bill-action-mark-as-void',
                       kwargs={
                           'entity_slug': self.ledger.entity.slug,
                           'bill_pk': self.uuid
                       })
    ...
    def get_mark_as_paid_url(self):
        return reverse('aix:bill-action-mark-as-paid',
                       kwargs={
                           'entity_slug': self.ledger.entity.slug,
                           'bill_pk': self.uuid
                       })
    ...
    def get_mark_as_canceled_url(self):
        return reverse('aix:bill-action-mark-as-canceled',
                       kwargs={
                           'entity_slug': self.ledger.entity.slug,
                           'bill_pk': self.uuid
                       })
