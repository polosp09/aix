...
from aix.urls.entity import urlpatterns as entity_urls
...
class EntityModelTests(DjangoLedgerBaseTest):
    ...
    def test_entity_create(self):
        ...
        # ENTITY-CREATE VIEW...
        entity_create_url = reverse('aix:entity-create')
    ...
    def test_entity_list(self):
        ...
        entity_list_url = reverse('aix:entity-list')
        ...
        with self.assertNumQueries(3):
            ...
            for entity_model in entity_qs:
                ...
                self.assertContains(response,
                                    status_code=200,
                                    text=reverse('aix:entity-delete',
                                                 kwargs={
    ...
    def test_entity_update(self):
        ...
        # ENTITY-UPDATE VIEW...
        with self.assertNumQueries(3):
            entity_update_url = reverse('aix:entity-update',
                                        kwargs={
    ...
    def test_entity_detail(self):
        ...
        with self.assertNumQueries(2):
            ...
            entity_detail_url = reverse('aix:entity-dashboard',
                                        kwargs={
                                            'entity_slug': entity_model.slug
                                        })
        ...
        with self.assertNumQueries(10):
            local_dt = localdate()
            entity_month_detail_url = reverse('aix:entity-dashboard-month',
                                              kwargs={
                                                  'entity_slug': entity_model.slug,
                                                  'year': local_dt.year,
    ...
    def test_delete_entity(self):
        ...
        # ENTITY-DELETE VIEW...
        with self.assertNumQueries(3):
            entity_delete_url = reverse('aix:entity-delete',
                                        kwargs={
                                            'entity_slug': entity_model.slug
                                        })
